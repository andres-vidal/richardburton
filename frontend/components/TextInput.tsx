  ...
  return (
    ...
    >
      ...
      <input
        ...
        ref={inputRef}
        value={value}
        className="w-full px-1 bg-transparent outline-none peer shrink grow placeholder:text-xs error:focus:text-white error:placeholder-white disabled:cursor-not-allowed"
