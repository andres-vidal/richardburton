...
Each lookup therefore carries a ticket, and only the newest one is allowed to
write what the field offers. Choosing a book takes a ticket too, which is what
retires whatever was in flight when it was chosen.
