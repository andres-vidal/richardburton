...
export async function generateMetadata({
  ...
  // What the record is, in the words a search result has room for. The address
  // is the same record whether or not it is being shown over the catalogue, so
  // one of the two is the canonical one.
  return {
    title,
